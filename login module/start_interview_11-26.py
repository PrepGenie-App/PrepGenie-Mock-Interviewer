...
def generate_questions(roles, data):
    ...
    text = f"If this is not a resume then return text uploaded pdf is not a resume. this is a resume overview of the candidate. 
            ...
            Not always necceassary to ask only technical questions related to the role but the logic of question should include the 
            job applied for because there might be some deep tech questions which the user might not know. Ask some personal questions too. 
            Ask no additional questions. Dont categorize the questions. ask 2 questions only. directly ask the questions not anything else. 
            ...
            tell anything else just give me the questions. if there is a limit in no of questions, ask or try questions that covers all need."
...
def generate_overall_feedback(data, percent, answer, questions):
    test = f"Here is the overview of the candidate {data}. Be just like a interviewer you 
            ...
            The candidate has answered the questions as follows: {answer}. Based on the answers provided, 
            the candidate has scored {percent}. dont tell the percent of the candidate, but rate them on 10 based on their answers. 
            ...
            The candidate has scored {percent} in the interview. If the candidate has answered the questions well and has a good understanding of the concepts.
            The candidate has scored well in the interview. If the answers are not good then tell the candidate has to improve alot with the answers. 
            Give me 2 paragraphs of feedback. 1st para about how was the interview and 2nd para about how the candidate can improve. dont fake. 
